...
import com.safelogic.cryptocomply.android.CryptoComplyFipsLoader;
import com.safelogic.cryptocomply.android.FipsApplicationError;
...
public class DemoApplication extends Application {
    ...
    protected void attachBaseContext(Context base) {
        ...
        try {
            ...
            throw new FipsApplicationError(var3);
        }

        try {
            SecureRandom entropySource = new SecureRandom();
            Security.insertProviderAt(newProvider(null, entropySource), 1);
        } catch (Throwable var2) {
            throw new FipsApplicationError(var2);
        }
    }

    private static Provider newProvider(String config, SecureRandom entropySource) throws ReflectiveOperationException {
        return (Provider)Class.forName("com.safelogic.cryptocomply.jcajce.provider.CryptoComplyFipsProvider").getDeclaredConstructor(String.class, SecureRandom.class).newInstance(config, entropySource);
    }
